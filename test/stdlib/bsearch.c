...
static void bsearch_int_test(void** state)
{
	...
	// i dont know why but if i choose some values from the n array  it give error and when i chose others it run perfectly 
	 int key = 3535; 
...
int bsearch_tests(void)
{
	...
	cmocka_unit_test(bsearch_test),
	cmocka_unit_test(bsearch_string_test),
	cmocka_unit_test(bsearch_string_test_1),
